...
public class ContatosRepositoryIntegrationTest {
    ...
    @Before
    public void start() {
        contato = new Contato("Luiz Teste", "81", "9xxxxxxx9");
    }
    ...
    public void auditoriaAposSalvarRetornaObjetoCorreto() {
        ...
        Assert.assertTrue("Luiz Teste".equals(contatoVindoDaAuditoria.getNome()));
    ...
    public void auditoriaAposEdicaoRetornaObjetoCorreto() {
        ...
        Assert.assertTrue("Rafael Teste".equals(contatoVindoDaAuditoria.getNome()));
